  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="space-y-1">
        ...
        <h1 className="text-2xl font-black text-[#181411] dark:text-white">Historial del Día</h1>
        <p className="text-[#8a7560] dark:text-[#a3907d]">
          Consulta los pedidos cerrados de la jornada con totales y métodos de pago.
        </p>
      </div>
      <div className="bg-white dark:bg-[#2d2419] border border-[#e6e0db] dark:border-[#3d3226] rounded-xl p-6 shadow-sm">
        <p className="text-sm text-[#4b5563] dark:text-[#a3907d]">
          Próximamente: listado de pedidos finalizados, filtros por rango horario y exportación.
        </p>
      </div>
    </div>
  );
