  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="space-y-1">
        ...
        <h1 className="text-2xl font-black text-[#181411] dark:text-white">Cambiar Evento</h1>
        <p className="text-[#8a7560] dark:text-[#a3907d]">
          Selecciona otro evento activo para continuar vendiendo en el punto de venta.
        </p>
      </div>
      <div className="bg-white dark:bg-[#2d2419] border border-[#e6e0db] dark:border-[#3d3226] rounded-xl p-6 shadow-sm">
        <p className="text-sm text-[#4b5563] dark:text-[#a3907d]">
          Próximamente: selector de eventos, validación de permisos y sincronización inmediata del POS.
        </p>
      </div>
    </div>
  );
