          ...
          if (Array.isArray(list)) {
            setUsers(
              list.map((u: any) => ({
                ...
                businessName: u.business?.name || u.business_name || '—',
          ...
          responses.forEach((resp) => {
            ...
            if (Array.isArray(data)) {
              data.forEach((u: any) => {
                ...
                const businessName = u.business?.name || u.business_name || '—';
                if (aggregated[id]) {
    ...
    <div className="flex flex-col gap-6">
      ...
      {modalOpen && (
        <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-center justify-center px-4">
          <div className="bg-white dark:bg-[#2d2419] rounded-xl shadow-2xl border border-primary/10 w-full max-w-xl p-6 relative">
            <button
